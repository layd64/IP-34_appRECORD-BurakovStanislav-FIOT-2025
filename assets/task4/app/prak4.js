document.addEventListener('DOMContentLoaded', function () {
    ...
    buttons[8].addEventListener('click', function () {
        ...
        modal.innerHTML = `
            <div class="slideshow-container">
                ...
                <div class="slideshow-content">
                    <img id="slideshow-image" src="slideshow_images/thumbnail1.png" alt="Slideshow image">
                </div>
        ...
        const images = [
            'slideshow_images/thumbnail1.png',
            'slideshow_images/thumbnail2.png',
            'slideshow_images/thumbnail3.png'
        ];
